...
from python.appledoublekaitai.resources import kaitai_utils
from python.appledoublekaitai.resources.apple_single_double import AppleSingleDouble


log = Logger(__name__)


class AppleDoubleKaitaiPlugin(ExtractionPlugin):

    def plugin_info(self):
        plugin_info = PluginInfo(
            id=PluginId(domain='domain', category='category', name='apple_double_kaitai_plugin'),
            version='0.0.1',
...
if __name__ == '__main__':
    ...
    run_with_hanskenpy(AppleDoubleKaitaiPlugin)
