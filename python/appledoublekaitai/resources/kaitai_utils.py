...
from typing import Any, BinaryIO, Dict, Generator, List
...
def write_to_json(data_binary: BinaryIO, writer: BufferedWriter, class_type: KaitaiStruct):
    """
...
def to_json_string(data_binary: BinaryIO, class_type: KaitaiStruct) -> str:
    """
